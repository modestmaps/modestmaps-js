describe('Transformation', function() {
    it('can do an identity transform', function() {
        ...
        expect(p).to.eql(new MM.Point(1, 1));
        expect(p_).to.eql(new MM.Point(1, 1));
        expect(p__).to.eql(new MM.Point(1, 1));
    });
    ...
    it('can do an inverse transform', function() {
        ...
        expect(p).to.eql(new MM.Point(0, 1));
        expect(p_).to.eql(new MM.Point(1, 0));
        expect(p__).to.eql(new MM.Point(0, 1));
    });
    ...
    it('can do an addition transform', function() {
        ...
        expect(p).to.eql(new MM.Point(0, 0));
        expect(p_).to.eql(new MM.Point(1,  1));
        expect(p__).to.eql(new MM.Point(0, 0));
    });
});
